          ...
          <div className="space-y-4 mb-6">
            {transactions.map(tx => (
              <div
                ...
                style={{
                  borderLeft: tx.isCoinbase ? '6px solid #facc15' : '6px solid #38bdf8',
                  ...
                  <div className="p-4">
                    <div className="flex flex-col md:flex-row justify-between">
                      ...
                      <div className="flex items-start space-x-3 mb-3 md:mb-0 md:w-2/5">
                        <div className={`${tx.isCoinbase ? 'bg-yellow-200' : 'bg-blue-200'} p-2 rounded-full flex-shrink-0 mt-1 shadow-sm`}>
                          {tx.isCoinbase ? 
                        ...
                        <div>
                          <h3 className="text-base font-semibold flex items-center">
                            {tx.isCoinbase ? 'Coinbase Transaction' : 'Transaction'}
                            <span className={`ml-2 text-xs py-0.5 px-2 rounded-full font-semibold ${tx.isCoinbase ? 'bg-yellow-100 text-yellow-700' : 'bg-blue-100 text-blue-700'}`}>{tx.confirmations > 0 ? `${tx.confirmations} Confirms` : 'Unconfirmed'}</span>
                          </h3>
                        ...
                        <div className="md:w-2/5 mb-2 md:mb-0">
                          ...
                          {tx.isCoinbase ? (
                            <div className="text-yellow-600 font-medium flex items-center">
                              <FaCoins className="mr-1" size={12} /> No Inputs (Newly Generated Coins)
                            </div>
